...
def find_distance(x, y):
    return x[2] + y[2] + abs(x[0][0] - y[0][0]) + abs(y[0][1] - x[0][1])
...
for move in moveset[0]:
    step = int(move[1:])
    if move[0] == 'U':
        vtable1.append([[pos[0], pos[1]], [pos[0] + step, pos[1]], steps])
        pos[0] += step
        steps += step
    elif move[0] == 'D':
        vtable1.append([[pos[0], pos[1]], [pos[0] - step, pos[1]], steps])
        ...
        htable1.append([[pos[0], pos[1]], [pos[0], pos[1] + step], steps])
        pos[1] += step
        steps += step
    elif move[0] == 'L':
        htable1.append([[pos[0], pos[1]], [pos[0], pos[1] - step], steps])
...
for move in moveset[1]:
    step = int(move[1:])
    if move[0] == 'U':
        vtable2.append([[pos[0], pos[1]], [pos[0] + step, pos[1]], steps])
        pos[0] += step
        steps += step
    elif move[0] == 'D':
        vtable2.append([[pos[0], pos[1]], [pos[0] - step, pos[1]], steps])
        ...
        htable2.append([[pos[0], pos[1]], [pos[0], pos[1] + step], steps])
        pos[1] += step
        steps += step
    elif move[0] == 'L':
        htable2.append([[pos[0], pos[1]], [pos[0], pos[1] - step], steps])
